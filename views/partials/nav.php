    ...
    <div class="flex h-16 items-center justify-between">
        ...
        <div class="ml-4 flex items-center md:ml-6">
            ...
            <div>
                ...
                <?php else : ?>
                    <a href="/register" class="flex w-full justify-center rounded-md bg-emerald-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-emerald-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600">Register</a>
                <?php endif; ?>
                </button>
            </div>
