        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <img class="h-8 w-8" src="https://tailwindui.com/img/logos/mark.svg?color=emerald&shade=500" alt="Your Company">
                </div>
                    ...
                    <div class="relative ml-3">
                        <div>
                            <button type="button" class="flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                ...
                                <?php else : ?>
                                    <a href="/login" class="flex w-full justify-center rounded-md bg-emerald-600 mr-3 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:outline hover:outline-emerald-400 hover:bg-transparent focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600">Login</a>
                                    <a href="/register" class="flex w-full justify-center rounded-md outline outline-emerald-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-emerald-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600">Register</a>
                                <?php endif; ?>
                            </button>
                        </div>
                        <?php if ($_SESSION['user'] ?? false) : ?>
